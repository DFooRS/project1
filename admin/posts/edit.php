    ...
    <div class="row">
        ...
        <div class="posts col-xxl-10 col-xl-10 col-lg-10 col-md-9 col-sm-12">
            <div class="container post-panel">
                <div class="row">
                    <h3 class="admin-title text-center text-uppercase">Редактировать запись</h3>
                </div>
                <div class="row add-post">
                    <form action="edit.php" method="POST">
                        ...
                        <label for="exampleFormControlTextarea1" class="form-label">Заголовок</label>
                            <input name="title" value="<?=$title;?>" type="text" class="form-control" placeholder="Название статьи" aria-label="Title">
                        </div>
                        <div class="col mb-3">
