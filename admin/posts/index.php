    ...
    <div class="row">
        ...
        <div class="posts col-xxl-10 col-xl-10 col-lg-10 col-md-9 col-sm-12">
            <div class="container post-panel">
                <div class="row">
                    <h3 class="admin-title text-center text-uppercase">Управление записями</h3>
                </div>
                <div class="row justify-content-center">
                    <a href="<?php echo BASE_URL . "admin/posts/create.php";?>"><button class="btn">Новая запись</button></a>
                </div>
                <div class="row title-table">
                    <div class="col-lg-1 col-1">ID</div>
                    <div class="col-lg-9 col-7">Название</div>
                    <div class="col-lg-2 col-4">Управление</div>
                </div>
                <?php foreach($posts as $key => $post): ?>
                <div class="row post">
                    <div class="id col-lg-1 col-1"><?=$key + 1;?></div>
                    <div class="title col-lg-9 col-7"><?=$post['title']?></a></div>
                    <div class="edit col-lg-1 col-2"><a href="edit.php?id=<?=$post['id']?>">Edit</a></div>
                    <div class="del col-lg-1 col-2"><a href="edit.php?delete_id=<?=$post['id']?>">Del</a></div>
                </div>
                <?php endforeach; ?>
            </div>
        </div>
