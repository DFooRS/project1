    ...
    <div class="row">
        ...
        <div class="sidebar col-xxl-2 col-xl-2 col-lg-2 col-md-3 col-sm-12">
            <div class="section panel-group d-xl-none d-lg-none d-md-none" data-bs-toggle="collapse" href="#collapse1">
                ...
                <!-- Это тоже надо переделать в инклюд (моб) -->
        ...
        <div class="posts col-xxl-10 col-xl-10 col-lg-10 col-md-9 col-sm-12">
            <div class="container post-panel">
                <div class="row">
                    <h3 class="admin-title text-center text-uppercase">Новый пост</h3>
                </div>
                <div class="row add-post">
                    ...
                    <div class="mb-3 err">
                        ...
                        <label for="exampleFormControlTextarea1" class="form-label">Перечислите категории через запятую</label>
                            <input name="topics" type="text" class="form-control" placeholder="Категория1, Категория2, Категория3 и так далее" aria-label="Title">
                        </div>
                        <div class="col mb-3">
                            <button name="add_post" class="btn" type="submit">Сохранить</button>
                        </div>
                    </form>
                </div>
            </div>
